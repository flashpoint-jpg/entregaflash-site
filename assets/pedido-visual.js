...
function efAcoesFixasHTML(p){
  // Enquanto uma confirmação estiver aberta, some com a barra fixa para não cobrir os botões do modal.
  if(estado.modalConfirmar||['entregue','cancelado'].includes(p.status))return '';
