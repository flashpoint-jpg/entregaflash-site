...
const CACHE='entrega-flash-admin-v11-20260901-sem-piscar';
const APP_SHELL=['/admin/admin.html?v=20260901-sem-piscar-1','/admin/manifest-admin.json','/admin/icon-admin-192.png','/admin/icon-admin-512.png'];
