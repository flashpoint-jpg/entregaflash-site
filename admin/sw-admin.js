...
const CACHE='entrega-flash-admin-v16-20260909-reset-senha';
const APP_SHELL=['/admin/admin.html?v=20260909-reset-senha-1','/admin/index.html?v=20260909-reset-senha-1','/admin/manifest-admin.json','/admin/icon-admin-192.png','/admin/icon-admin-512.png'];
